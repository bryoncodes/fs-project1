...
class movie:
  """
  movie class, constructor takes the following parameters:
...
m1 = movie(
  "Idiocracy",
  "http://i.imgur.com/UWHnbYv.jpg",
  "https://www.youtube.com/watch?v=BBvIweCIgwk",
  ["Luke Wilson", "Maya Rudolph", "Justin Long"])

m2 = movie(
  "Full Metal Jacket",
  "http://i.imgur.com/k67OMUe.jpg",
  "https://www.youtube.com/watch?v=x9f6JaaX7Wg",
  ["R. Lee Ermy", "Matthew Modine", "Adam Baldwin"])

m3 = movie(
  "Office Space",
  "http://i.imgur.com/952MNeQ.jpg",
  "https://www.youtube.com/watch?v=_IwzZYRejZQ",
  ["Ron Livingstone", "Jennifer Aniston", "Gary Cole"])

m4 = movie(
  "Sling Blade",
  "http://i.imgur.com/K5OESky.jpg",
  "https://www.youtube.com/watch?v=4sQuu36ZKQg",
  ["Billy Bob Thornton", "Dwight Yoakum", "John Ritter"])

m5 = movie(
  "Blazing Saddles",
  "http://i.imgur.com/JP0vley.jpg",
